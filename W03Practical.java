...
public class W03Practical {
    ...
    public static void main(String[] args) {
        ...
        try {
            readFile(args);
        } catch (IOException e){ // In all cases, should only trigger if file input is invalid; other potential exceptions handled in subsequent methods
            System.out.println("IO Exception: file in unexpected format or not found");
        } catch (ArrayIndexOutOfBoundsException e) { // Triggers if data not in expected format
